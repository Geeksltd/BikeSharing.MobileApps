...
namespace UI._Custom
{
    ...
    {
        public const string AuthenticationEndpoint = "http://bikesharing-services-profilestgr242k3hirba.azurewebsites.net/";
        public const string EventsEndpoint = "http://bikesharing-services-eventstgr242k3hirba.azurewebsites.net/";
        public const string IssuesEndpoint = "http://bikesharing-services-feedbacktgr242k3hirba.azurewebsites.net/";
        public const string RidesEndpoint = "http://bikesharing-services-ridestgr242k3hirba.azurewebsites.net/";
